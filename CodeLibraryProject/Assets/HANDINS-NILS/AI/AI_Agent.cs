...
{
    [Space(75)] [SerializeField] protected List<Transform> targetCollection;
    [SerializeField] private AI_ScrObject agentFile;
    [SerializeField] private List<Vector3> currentPathPositions = new List<Vector3>();
    ...
    private void Awake()
    {
        ...
        Debug.Assert(queue != null, "PathQueue reference in AI_Agent is null.}");
    }
