...
public class VoxelMapVisualization : MonoBehaviour
{
    ...
    [Header("Octree visuals")] 
    [SerializeField] private bool showOctreeDivisions;
    ...
    private void drawOctreeDivisions()
    {
        ...
        SerializableDictionary<int, OctreeContainer> collection = voxelCalculator.voxelGridSaveFile.OctreeDivisions[octreeDivisionDepth];
